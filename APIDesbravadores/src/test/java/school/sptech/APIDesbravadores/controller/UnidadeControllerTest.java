...
class UnidadeControllerTest {
    ...
    @Test
    void listarUnidadesDeveRetornarNoContentQuandoClubeNaoTiverUnidades() throws Exception {
        autenticar(diretor());
        when(unidadeService.listaUnidade(10)).thenReturn(List.of());
